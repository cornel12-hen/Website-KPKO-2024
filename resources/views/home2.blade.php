...
<body class="flex justify-center items-center bg-coklat w-screen h-screen">
    <main class="sm:hidden flex flex-col bg-[#E3D8C6] max-w-full max-h-full overflow-y-scroll overflow-x-hidden">
        <div class="border border-t-0 border-r-0 border-coklat pointer-events-none select-none no-drag">
        ...
        <div class="text-center p-6 select-none no-drag">
            ...
            <a href="/login">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-8 relative top-[53vh] left-[49.5vw] fill-coklat animate-color-change-scale-up">
                    <path fill-rule="evenodd" d="M4.5 5.653c0-1.427 1.529-2.33 2.779-1.643l11.54 6.347c1.295.712 1.295 2.573 0 3.286L7.28 19.99c-1.25.687-2.779-.217-2.779-1.643V5.653Z" clip-rule="evenodd" />
                </svg>
            </a>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-7 relative top-[53vh] left-[44.6vw] fill-coklat">
                <path fill-rule="evenodd" d="M9.53 2.47a.75.75 0 0 1 0 1.06L4.81 8.25H15a6.75 6.75 0 0 1 0 13.5h-3a.75.75 0 0 1 0-1.5h3a5.25 5.25 0 1 0 0-10.5H4.81l4.72 4.72a.75.75 0 1 1-1.06 1.06l-6-6a.75.75 0 0 1 0-1.06l6-6a.75.75 0 0 1 1.06 0Z" clip-rule="evenodd" />
            </svg>              
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-7 relative top-[53vh] left-[54.4vw] fill-coklat">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-8 relative top-[58vh] left-[51.7vw] fill-biru3 animate-move-up-left pointer-events-none">
        ...
        <div class="border border-t-0 border-l-0 border-coklat pointer-events-none select-none no-drag">
            <img class="w-full h-full" src="img/stamp2.png" alt="">
        </div>
        <div class="border border-l-0 border-b-0 border-coklat pointer-events-none select-none no-drag">
            <img class="w-full h-full" src="img/stamp1.png" alt="">
        </div>
        <div class="border border-b-0 border-coklat pointer-events-none select-none no-drag">
